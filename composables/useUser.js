...
// Define a function that uses 'useState' to create a state variable of type 'User'.
export default function () {
  // Use 'useState' to create a state variable named 'user'.
  // The second argument is a function that returns the initial value of 'user' (in this case, 'null').
